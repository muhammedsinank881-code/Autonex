...
const OrderActionBar = ({
    ...
    const nextStatus =
        nextStatusMap[order.orderStatus] || null;
                    ...
                    visibleActions.map((action) => {
                        ...
                        return (
                            <button
                                ...
                                className={`group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-sm font-medium transition-all ${action.danger
                                        ? "text-red-500 hover:bg-red-50"
                                        : "text-slate-600 hover:bg-slate-100 hover:text-[#0067B2]"
                                    }`}
                            >
                                <span
                                    className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg ${action.danger
